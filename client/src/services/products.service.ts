...
export async function createProductRequest(data: CreateProductInput): Promise<Product> {
    return await api.post('/products', data)
}

export async function updateProductRequest(id: string, data: UpdateProductInput): Promise<Product> {
